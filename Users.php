  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
    ...
    <header id ="header">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><span class="glyphicon glyphicon-user" aria-hidden="true">Users</span><small> Manage all the users</small></h1>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="Users.php" class="list-group-item list-group-item-action active main-colour-bg"><span class="glyphicon glyphicon-user"> Users</span></a>
                                ...
                                <tbody>
                                     ...
                                     if($table->num_rows>0)
                                     {
                                         while($row=$table->fetch_assoc())
                                         {
                                             ...
                                             "<td>";
                                        ?>
                                            <!-- <button type="button" class="btn btn-default" data-toggle="modal" data-target="#editUser"><span class='glyphicon glyphicon-pencil' name='edit' aria-hidden='true'></span></button> -->
                                        <?php
                                            "</td>";
                                         }
                                     }
