  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="ManagerBoard.php">Dashboard</a></li>
    ...
    <header id ="header">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><span class="glyphicon glyphicon-scissors" aria-hidden="true">Orders</span><small> View all the orders</small></h1>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="ProductList.php" class="list-group-item list-group-item-action"><span class="glyphicon glyphicon-scissors"> Products</a>
                        <a href="ManagerOrders.php" class="list-group-item list-group-item-action active main-colour-bg"><span class="glyphicon glyphicon-list-alt"> Orders</span></a>
